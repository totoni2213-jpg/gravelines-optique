    ...
    PostHogFeatureFlags.prototype._callFlagsEndpoint = function (options) {
        ...
        this._instance._send_request({
            ...
            callback: function (response) {
                ...
                var isQuotaLimited = !!((_d = (_c = response.json) === null || _c === void 0 ? void 0 : _c.quotaLimited) === null || _d === void 0 ? void 0 : _d.includes(QuotaLimitedResource.FeatureFlags));
                if (isQuotaLimited) {
                    flagErrors.push(exports.FeatureFlagError.QUOTA_LIMITED);
                }
                (_e = _this._instance.persistence) === null || _e === void 0 ? void 0 : _e.register((_a = {},
    ...
    PostHogFeatureFlags.prototype.getFeatureFlagResult = function (key, options) {
        ...
        if (options.send_event || !('send_event' in options)) {
            if (!(key in flagCallReported) || !flagCallReported[key].includes(flagReportValue)) {
                ...
                var errors = __spreadArray([], __read(((_c = this._instance.get_property(constants_1.PERSISTENCE_FEATURE_FLAG_ERRORS)) !== null && _c !== void 0 ? _c : [])), false);
                ...
                var properties = {
                    ...
                    $feature_flag_bootstrapped_response: ((_e = (_d = this._instance.config.bootstrap) === null || _d === void 0 ? void 0 : _d.featureFlags) === null || _e === void 0 ? void 0 : _e[key]) || null,
                    $feature_flag_bootstrapped_payload: ((_g = (_f = this._instance.config.bootstrap) === null || _f === void 0 ? void 0 : _f.featureFlagPayloads) === null || _g === void 0 ? void 0 : _g[key]) || null,
                ...
                if (!(0, core_1.isUndefined)((_h = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _h === void 0 ? void 0 : _h.version)) {
                    properties.$feature_flag_version = flagDetails.metadata.version;
                }
                var reason = (_k = (_j = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.reason) === null || _j === void 0 ? void 0 : _j.description) !== null && _k !== void 0 ? _k : (_l = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.reason) === null || _l === void 0 ? void 0 : _l.code;
                if (reason) {
                    properties.$feature_flag_reason = reason;
                }
                if ((_m = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _m === void 0 ? void 0 : _m.id) {
                ...
                if ((_o = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _o === void 0 ? void 0 : _o.original_payload) {
                    properties.$feature_flag_original_payload = (_p = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _p === void 0 ? void 0 : _p.original_payload;
                }
                if (errors.length) {
